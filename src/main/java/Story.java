...
public class Story {
    ...
    public void editNode(int nodeID, String editChoice){
        ...
        if (editChoice.equals("children")){
            System.out.print("Would you like to edit or delete a child? (edit or delete)");
    ...
    public HashMap getNodeConnections(){
